        ...
        <div className="px-3 py-2 space-y-1.5">
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-2">
              <span className="text-white text-xs font-display uppercase tracking-wider font-bold truncate max-w-[90px]">{game.away_team_name}</span>
              <span className="text-stadium-400 text-[10px]">F:{awayFouls}</span>
            </div>
            <span className="text-white text-xl font-black tabular-nums">{game.away_score}</span>
          </div>
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-2">
              <span className="text-white text-xs font-display uppercase tracking-wider font-bold truncate max-w-[90px]">{game.home_team_name}</span>
              <span className="text-stadium-400 text-[10px]">F:{homeFouls}</span>
            </div>
